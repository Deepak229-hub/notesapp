const LeftContent = ({changeHandler, addNote, title, text}) => {
    return (
        <div className="lg:border-r w-full h-1/2 lg:w-1/2 lg:h-full lg:py-3 px-6">
            ...
            <textarea value={text} className="p-3 w-full resize-none h-[25vh] lg:h-[70vh] outline-none text-justify" placeholder="Enter text..." onChange={changeHandler}></textarea>
