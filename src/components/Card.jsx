...
const Card = ({title, text, id, deleteNote, show}) => {
    return (
        <div className="bg-gray-800 snap-center flex flex-col rounded-lg p-4 w-full h-[calc(100vh/3)] shrink-0">
            <h4 className="font-bold flex-1">{title}</h4>
            <hr className="border-gray-600" />
            <p className="text-sm line-clamp-8 flex-4 text-justify">{text}</p>
            <div className="flex flex-row gap-2 justify-around items-end flex-1">
